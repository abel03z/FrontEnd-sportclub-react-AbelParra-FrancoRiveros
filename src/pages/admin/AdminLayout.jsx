...
const LINKS = [
  ...
  { to: "/admin/dashboard/deportes", label: "Deportes" },
  { to: "/admin/dashboard/salas", label: "Salas" },
  { to: "/admin/dashboard/asignaciones", label: "Asignaciones" },
  { to: "/admin/dashboard/horarios", label: "Horarios" },
  { to: "/admin/dashboard/perfil", label: "Mi Perfil" },
];
...
export default function AdminLayout() {
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      {/* Estilos responsive: en pantallas chicas el sidebar se convierte
          en un panel deslizante controlado por el botón hamburguesa. */}
      <style>{`
      ...
      >
        ...
        <span className="text-white fw-semibold">SportClub Admin</span>
        <span style={{ width: 40 }} />
      </div>
      ...
      <div className="d-flex">
        <aside
          ...
          style={{ width: 220, backgroundColor: "#1f2430", color: "white" }}
        >
          <h5 className="mb-4 d-none d-md-block">SportClub Admin</h5>
