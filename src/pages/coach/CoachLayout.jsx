...
const LINKS = [
  { to: "/coach/dashboard/clases", label: "Mis Clases" },
  { to: "/coach/dashboard/horario", label: "Mi Horario" },
  { to: "/coach/dashboard/perfil", label: "Mi Perfil" },
];
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        <span className="text-white fw-semibold">SportClub Coach</span>
        <span style={{ width: 40 }} />
      </div>
      ...
      <div className="d-flex">
        <aside
          ...
          style={{ width: 220, backgroundColor: "#1f3a2e", color: "white" }}
        >
          <h5 className="mb-4 d-none d-md-block">SportClub Coach</h5>
